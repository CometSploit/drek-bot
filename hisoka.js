...
break
	    ...
	    break
            ...
            m.reply(mess.wait)
                ...
                let encmedia = await hisoka.sendImageAsSticker(m.chat, media, m, { packname: "visit", author: "https://termux.my.id" })
                await fs.unlinkSync(encmedia)
            } else if (/video/.test(mime)) {
                if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
                let media = await quoted.download()
                let encmedia = await hisoka.sendVideoAsSticker(m.chat, media, m, { packname: "visit", author: "https://termux.my.id" })
                await fs.unlinkSync(encmedia)
            } else {
